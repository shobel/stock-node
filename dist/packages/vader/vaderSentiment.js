...
exports.SentiText = exports.is_upper_python = exports.scalar_inc_dec = exports.allcap_differential = exports.normalize = exports.negated = exports.SPECIAL_CASE_IDIOMS = exports.BOOSTER_DICT = exports.NEGATE = exports.PUNC_LIST = exports.REGEX_REMOVE_PUNCTUATION = exports.N_SCALAR = exports.C_INCR = exports.B_DECR = exports.B_INCR = void 0;
/**
...
*/
// Constants
let LEXICON = require('./vader_lexicon.js').lexicon;
let STOCK_LEXICON = require('./stock_lexicon.js').lexicon;
let REGULAR_LEXICON = require('./vader_lexicon.js').lexicon;
// (empirically derived mean sentiment intensity rating increase for booster words)
exports.B_INCR = 0.293;
exports.B_DECR = -0.293;
// (empirically derived mean sentiment intensity rating increase for using
// ALLCAPs to emphasize a word)
exports.C_INCR = 0.733;
exports.N_SCALAR = -0.74;
exports.REGEX_REMOVE_PUNCTUATION = new RegExp(/[!"#$%&'()*+,-./:;<=>?@[\\\]^_`{|}~]/g);
...
exports.BOOSTER_DICT = {
    absolutely: exports.B_INCR,
    amazingly: exports.B_INCR,
    awfully: exports.B_INCR,
    completely: exports.B_INCR,
    considerably: exports.B_INCR,
    decidedly: exports.B_INCR,
    deeply: exports.B_INCR,
    effing: exports.B_INCR,
    enormously: exports.B_INCR,
    entirely: exports.B_INCR,
    especially: exports.B_INCR,
    exceptionally: exports.B_INCR,
    extremely: exports.B_INCR,
    fabulously: exports.B_INCR,
    flipping: exports.B_INCR,
    flippin: exports.B_INCR,
    fricking: exports.B_INCR,
    frickin: exports.B_INCR,
    frigging: exports.B_INCR,
    friggin: exports.B_INCR,
    fully: exports.B_INCR,
    fucking: exports.B_INCR,
    greatly: exports.B_INCR,
    hella: exports.B_INCR,
    highly: exports.B_INCR,
    hugely: exports.B_INCR,
    incredibly: exports.B_INCR,
    intensely: exports.B_INCR,
    majorly: exports.B_INCR,
    more: exports.B_INCR,
    most: exports.B_INCR,
    particularly: exports.B_INCR,
    purely: exports.B_INCR,
    quite: exports.B_INCR,
    really: exports.B_INCR,
    remarkably: exports.B_INCR,
    so: exports.B_INCR,
    substantially: exports.B_INCR,
    thoroughly: exports.B_INCR,
    totally: exports.B_INCR,
    tremendously: exports.B_INCR,
    uber: exports.B_INCR,
    unbelievably: exports.B_INCR,
    unusually: exports.B_INCR,
    utterly: exports.B_INCR,
    very: exports.B_INCR,
    almost: exports.B_DECR,
    barely: exports.B_DECR,
    hardly: exports.B_DECR,
    'just enough': exports.B_DECR,
    'kind of': exports.B_DECR,
    kinda: exports.B_DECR,
    kindof: exports.B_DECR,
    'kind-of': exports.B_DECR,
    less: exports.B_DECR,
    little: exports.B_DECR,
    marginally: exports.B_DECR,
    occasionally: exports.B_DECR,
    partly: exports.B_DECR,
    scarcely: exports.B_DECR,
    slightly: exports.B_DECR,
    somewhat: exports.B_DECR,
    'sort of': exports.B_DECR,
    sorta: exports.B_DECR,
    sortof: exports.B_DECR,
    'sort-of': exports.B_DECR
};
// check for special case idioms using a sentiment-laden keyword known to VADER
exports.SPECIAL_CASE_IDIOMS = {
    'the shit': 3,
    'the bomb': 3,
    'bad ass': 1.5,
    'yeah right': -2,
...
// static methods
exports.negated = (input_words, include_nt = true) => {
    /**
      Determine if input contains negation words
     */
    let neg_words = [];
    neg_words.push.apply(neg_words, exports.NEGATE);
...
exports.normalize = (score, alpha = 15) => {
    /**
...
exports.allcap_differential = words => {
    /**
      Check whether just some words in the input are ALL CAPS
    */
    let allcap_words = 0;
    for (let i = 0; i < words.length; i++) {
        if (exports.is_upper_python(words[i])) {
            allcap_words += 1;
        }
    }
...
exports.scalar_inc_dec = (word, valence, is_cap_diff) => {
    /**
    ...
    if (exports.BOOSTER_DICT.hasOwnProperty(word_lower)) {
        scalar = exports.BOOSTER_DICT[word_lower];
        if (valence < 0) {
            scalar *= -1;
        }
        // check if booster/dampener word is in ALLCAPS (while others aren't)
        if (is_cap_diff && exports.is_upper_python(word)) {
            if (valence > 0) {
                scalar += exports.C_INCR;
            }
            else {
                scalar -= exports.C_INCR;
            }
...
class SentiText {
    ...
    */
    constructor(text) {
        ...
        this.is_cap_diff = exports.allcap_differential(this.words_and_emoticons);
    }
    get_words_plus_punc() {
        /**
        ...
        const no_punc_text = this.text.slice(0).replace(exports.REGEX_REMOVE_PUNCTUATION, '');
        ...
        let words_punc_dict = {};
        for (let j = 0; j < exports.PUNC_LIST.length; j++) {
            for (let k = 0; k < words_only.length; k++) {
                let pb = `${exports.PUNC_LIST[j]}${words_only[k]}`;
                let pa = `${words_only[k]}${exports.PUNC_LIST[j]}`;
...
class SentimentIntensityAnalyzer {
    ...
    */
    static setStockLexicon(bool) {
        if (bool) {
            LEXICON = STOCK_LEXICON;
        }
        else {
            LEXICON = REGULAR_LEXICON;
        }
    }
    static polarity_scores(text) {
        ...
        */
        ...
        for (let i = 0; i < words_and_emoticons.length; i++) {
            ...
            if ((i < words_and_emoticons.length - 1 &&
                item.toLowerCase() === 'kind' &&
                words_and_emoticons[i + 1].toLowerCase() === 'of') ||
                exports.BOOSTER_DICT.hasOwnProperty(item.toLowerCase())) {
    ...
    static sentiment_valence(valence, sentiText, item, index, sentiments) {
        ...
        if (LEXICON.hasOwnProperty(item_lowercase)) {
            ...
            if (exports.is_upper_python(item) && is_cap_diff) {
                if (valence > 0) {
                    valence += exports.C_INCR;
                }
                else {
                    valence -= exports.C_INCR;
                }
            ...
            for (let start_i = 0; start_i < 3; start_i++) {
                if (index > start_i &&
                    ...
                    let s = exports.scalar_inc_dec(words_and_emoticons[index - (start_i + 1)], valence, is_cap_diff);
                    if (start_i === 1 && s !== 0) {
                        s = s * 0.95;
                    }
    ...
    static least_check(valence, words_and_emoticons, index) {
        ...
        */
        if (index > 1 &&
            ...
            if (words_and_emoticons[index - 2].toLowerCase() !== 'at' &&
                words_and_emoticons[index - 2].toLowerCase() !== 'very') {
                valence = valence * exports.N_SCALAR;
            }
        }
        else if (index > 0 &&
            words_and_emoticons[index - 1].toLowerCase() === 'least' &&
    ...
    static idioms_check(valence, words_and_emoticons, index) {
        ...
        for (let i = 0; i < sequences.length; i++) {
            if (exports.SPECIAL_CASE_IDIOMS.hasOwnProperty(sequences[i])) {
                valence = exports.SPECIAL_CASE_IDIOMS[sequences[i]];
                break;
            }
        }
        if (words_and_emoticons.length - 1 > index) {
            const zeroone = `${words_and_emoticons[index]} ${words_and_emoticons[index + 1]}`;
            if (exports.SPECIAL_CASE_IDIOMS.hasOwnProperty(zeroone)) {
                valence = exports.SPECIAL_CASE_IDIOMS[zeroone];
            }
        }
        if (words_and_emoticons.length - 1 > index + 1) {
            ...
            if (exports.SPECIAL_CASE_IDIOMS.hasOwnProperty(zeroonetwo)) {
                valence = exports.SPECIAL_CASE_IDIOMS[zeroonetwo];
            }
        }
        // check for booster/dampener bi-grams such as 'sort of' or 'kind of'
        if (exports.BOOSTER_DICT.hasOwnProperty(threetwo) || exports.BOOSTER_DICT.hasOwnProperty(twoone)) {
            valence = valence + exports.B_DECR;
        }
        return valence;
    }
    static never_check(valence, words_and_emoticons, start_i, index) {
        if (start_i === 0) {
            if (exports.negated([words_and_emoticons[index - 1]])) {
                valence = valence * exports.N_SCALAR;
            }
        }
        if (start_i === 1) {
            if (words_and_emoticons[index - 2] === 'never' &&
                (words_and_emoticons[index - 1] === 'so' || words_and_emoticons[index - 1] === 'this')) {
                valence = valence * 1.5;
            }
            else if (exports.negated([words_and_emoticons[index - (start_i + 1)]])) {
                valence = valence * exports.N_SCALAR;
            }
        }
        if (start_i === 2) {
            if ((words_and_emoticons[index - 3] === 'never' &&
    ...
    static score_valence(sentiments, text) {
        if (sentiments && sentiments.length > 0) {
            ...
            let compound = exports.normalize(sum_s);
...
exports.default = SentimentIntensityAnalyzer;
//# sourceMappingURL=vaderSentiment.js.map